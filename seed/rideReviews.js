  ...
  const rides = [
    {
      ...
      description: 'Fly down the tracks and splash into the wave pools on this brand new family friendly water ride!',
    ...
    },
    {
      ...
      description: 'A dinosaur shaped roller coaster will bring you out the most fun adventure!',
      height_requirement: false,
      intensity: 2,
      reviews: review1._id
    },
